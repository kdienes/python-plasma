...
('libplasma',
 [ 'plasma.c' ],
 include_dirs = [ os.path.join (hadron.tools.config.G_SPEAK_DIR, 'include') ],
 library_dirs = [ os.path.join (hadron.tools.config.G_SPEAK_DIR, 'lib') ],
 runtime_library_dirs = [ os.path.join (hadron.tools.config.G_SPEAK_DIR, 'lib') ],
 libraries = [ 'Plasma' ],
